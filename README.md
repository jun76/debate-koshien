...
pnpm --filter @debate-koshien/server exec tsx scripts/smoke.ts   # 実 CLI アダプタの疎通確認
```
...
- [piper-plus](https://github.com/ayutaz/piper-plus)（MIT）— `scripts/setup-tts.ps1` / `scripts/setup-tts.sh` で
